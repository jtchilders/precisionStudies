module test_ddacosh
  use ddfuna  ! Import the module containing the ddacosh subroutine
  implicit none

contains

  subroutine unittest_ddacosh(filename)
    implicit none
  ...
  end subroutine unittest_ddacosh

end module test_ddacosh