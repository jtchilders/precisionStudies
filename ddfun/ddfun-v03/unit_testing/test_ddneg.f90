module test_ddneg
  use ddfuna  ! Import the module containing the ddneg subroutine
  implicit none

contains

  subroutine unittest_ddneg(filename)
    implicit none
  ...
  end subroutine unittest_ddneg

end module test_ddneg