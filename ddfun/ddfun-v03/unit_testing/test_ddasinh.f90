module test_ddasinh
  use ddfuna  ! Import the module containing the ddasinh subroutine
  implicit none

contains

  subroutine unittest_ddasinh(filename)
    implicit none
    ...
    do
      ...
      ! Call the ddasinh subroutine
      call ddasinh(dda, ddb)
  ...
  end subroutine unittest_ddasinh

end module test_ddasinh