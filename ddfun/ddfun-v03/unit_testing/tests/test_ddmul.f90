module test_ddmul
  use ddfuna  ! Import the module containing the ddmul subroutine
  implicit none

contains

  subroutine unittest_ddmul(filename)
    implicit none
    ...
    write(*,*) "Running tests for ddmul from:", filename
    ...
    do
      ...
      ! Call the ddmul subroutine
      call ddmul(dda, ddb, ddc)
  ...
  end subroutine unittest_ddmul

end module test_ddmul
