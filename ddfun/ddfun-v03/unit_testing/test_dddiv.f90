module test_dddiv
  use ddfuna  ! Import the module containing the dddiv subroutine
  implicit none

contains

  subroutine unittest_dddiv(filename)
    implicit none
    ...
    write(*,*) "Running tests for dddiv from:", filename
    ...
    do
      ...
      ! Call the dddiv subroutine
      call dddiv(dda, ddb, ddc)
  ...
  end subroutine unittest_dddiv

end module test_dddiv
