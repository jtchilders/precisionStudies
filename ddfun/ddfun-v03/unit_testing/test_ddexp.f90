module test_ddexp
  use ddfuna  ! Import the module containing the ddexp subroutine
  implicit none

contains

  subroutine unittest_ddexp(filename)
    implicit none
    ...
    tolerance = 5.0e-30  ! Double-double precision tolerance
    total_tests = 0
    passed_tests = 0
  ...
  end subroutine unittest_ddexp

end module test_ddexp