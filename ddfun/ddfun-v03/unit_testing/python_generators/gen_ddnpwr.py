...
def generate_test_cases(num_cases):
    ...
    while len(cases) < num_cases:
        try:
            cases.append(generate_ddnpwr_test_case())
        except ValueError:
            continue
    return cases
...
if __name__ == "__main__":
    ...
    write_test_cases_to_text_file("ddnpwr_test_cases.txt", test_cases)
    write_test_cases_to_binary("ddnpwr_test_cases.bin", test_cases)