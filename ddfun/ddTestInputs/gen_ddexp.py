...
def generate_ddexp_test_case():
   """
   Generate a test case for ddexp using a random value within a range.
   """
   # Generate a random value for the exponent input
   a = mp.rand() * 600 - 300  # Adjust range for ddexp
   ...
   if not (valid_a and valid_result):
      print(
         f"Verification of ddexp failed for tolerance {tolerance}:\n"
...
if __name__ == "__main__":
   print("Generating test cases for ddexp...")
