#ifndef TEST_DDCDIV_H
#define TEST_DDCDIV_H
...
void unittest_ddcdiv(const std::string &filename) {
   ...
   std::cout << "Running tests for ddcdiv from: " << filename << std::endl;
