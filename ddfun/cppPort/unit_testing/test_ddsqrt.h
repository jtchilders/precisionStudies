#ifndef TEST_DDSQRT_H
#define TEST_DDSQRT_H
...
void unittest_ddsqrt(const std::string &filename) {
   ...
   std::cout << "Running tests for ddsqrt from: " << filename << std::endl;
