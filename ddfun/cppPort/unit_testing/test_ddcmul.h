#ifndef TEST_DDCMUL_H
#define TEST_DDCMUL_H
...
void unittest_ddcmul(const std::string &filename) {
   ...
   std::cout << "Running tests for ddcmul from: " << filename << std::endl;
